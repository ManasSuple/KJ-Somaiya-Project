      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <h4 className="font-semibold text-sm text-gray-900 mb-2">Demo Credentials:</h4>
            <div className="text-xs text-gray-600 space-y-1">
              <p><strong>Faculty:</strong> rajesh.kumar@somaiya.edu | admin123</p>
              <p><strong>Super Admin:</strong> priya.sharma@somaiya.edu | admin123</p>
            </div>
          </div>
        </CardContent>
      </Card>
