...
const ContentArea: React.FC<ContentAreaProps> = ({ activeSection, userRole }) => {
  ...
  // Assign Roles previously used public.students. All related code has been removed per approval.
  ...
  // On mount: no-op for roles (students removed)
  ...
  const renderManageRoles = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 text-center text-gray-500">No data source configured yet.</div>
      </div>
    </div>
  );
